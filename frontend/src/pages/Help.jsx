    ...
    <div className="help-page">
      ...
      <div className="help-grid">
        ...
        <div className="help-card">
          ...
          <p>
            Learn how to upload PDFs, generate summaries, and manage your
            study materials.
          </p>
        </div>
        ...
        <div className="help-card">
          ...
          <h2>AI Quizzes</h2>
          <p>
            Learn how to generate quizzes, answer questions, and review your
            quiz results.
          </p>
        </div>
        ...
        <div className="help-card">
          ...
          <h2>Weak Topics</h2>
          <p>
            Understand how weak topics are identified and how you can review
            them.
          </p>
        </div>

        <div className="help-card">
          <div className="help-icon pink">📅</div>
          <h2>Study Planner</h2>
          <p>
        ...
        <div className="help-card">
          <div className="help-icon teal">🤖</div>
          <h2>AI Assistant</h2>
          <p>
      ...
      <div className="help-contact">
        <div>
          <span className="help-label">STILL NEED HELP?</span>
          <h2>We're here to help</h2>
          <p>
            If you cannot find what you are looking for, check the available
            study features or return to your dashboard.
          </p>
        </div>
